...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground p-6 md:p-10 relative">
            ...
            {/* Judges' Demo Mode Top Strip */}
            <div className="mb-6 rounded-xl border border-accent/40 bg-accent/10 px-4 py-2.5 backdrop-blur-md flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
                <div className="flex items-center gap-2 font-medium">
                    <Presentation size={16} className="text-accent shrink-0" />
                    <span>
                        <strong className="text-foreground">SIH Evaluator Mode:</strong> Live Supabase Database, 3D Neural Scene, and MoSPI Assessment are active.
                    </span>
                </div>
                <button
                    type="button"
